...
fractal_cuda_value_to_rgb_lavender(uint8_t * r, uint8_t * g, uint8_t * b, int value) {
    static const uint8_t colormap[34][3] = {
       { 69, 147, 254},
       {101, 154, 214},
       {108, 122, 211},
       {114,  89, 203},
...
__device__ colorfunc_t colorfuncs[FC_COLOR_NUM_ENTRIES] = {
    fractal_cuda_value_to_rgb_ultra,
    fractal_cuda_value_to_rgb_monochrome,
    fractal_cuda_value_to_rgb_tri,
    fractal_cuda_value_to_rgb_jet,
    fractal_cuda_value_to_rgb_lavender,
    fractal_cuda_value_to_rgb_binary,
};
