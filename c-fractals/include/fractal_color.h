...
struct Buddha
{
    int real_steps; /**< The number of steps to divide the real part of the complex plane */
    int imag_steps; /**< The number of steps to divide the imaginary part of the complex plane */
};
...
struct FractalProperties
{
    ...
    struct Buddha buddha;   /**< Buddha properties */
 ...
 */
void
fractal_cmatrix_save_raw(HCMATRIX hCmatrix, const char* filename);
 ...
 */
colorfunc_t
fractal_colorfunc_get(enum FC_Color color);
